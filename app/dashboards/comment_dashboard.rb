...
class CommentDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = %i[name body post].freeze

  # SHOW_PAGE_ATTRIBUTES
  # an array of attributes that will be displayed on the model's show page.
  SHOW_PAGE_ATTRIBUTES = %i[id body name post created_at updated_at].freeze

  # FORM_ATTRIBUTES
  # an array of attributes that will be displayed
  # on the model's form (`new` and `edit`) pages.
  FORM_ATTRIBUTES = %i[body name post].freeze
